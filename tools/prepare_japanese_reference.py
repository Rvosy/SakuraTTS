...
LOCAL_FILES = ("tools/prepare_japanese_reference.py", "research/tools/prepared_reference.py",
...
def worker(run):
    ...
    try:
        ...
        os.chdir(repo)
        sys.path[:0] = [str(PROJECT / "research/tools"), str(repo / "GPT_SoVITS"), str(repo)]
