...
```sh
../SakuraTTS-References/.venv-mlx-macos/bin/python harness/text_frontend_equivalence.py prepare \
...
../SakuraTTS-References/.venv-mlx-macos/bin/python harness/text_frontend_equivalence.py offline --run "$JAPANESE_TEXT_RUN"
../SakuraTTS-References/.venv-official-macos/bin/python harness/text_frontend_equivalence.py worker \
  --run "$JAPANESE_TEXT_RUN" --backend official
../SakuraTTS-References/.venv-mlx-macos/bin/python harness/text_frontend_equivalence.py worker \
  --run "$JAPANESE_TEXT_RUN" --backend native
../SakuraTTS-References/.venv-mlx-macos/bin/python harness/text_frontend_equivalence.py compare --run "$JAPANESE_TEXT_RUN"
```
