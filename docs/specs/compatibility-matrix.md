...
更新日期：2026-09-20。证据包括 [Mac 上游功能冒烟](../experiments/2026-09-19-macos-reference-smoke.md)、[调用链与固定历史对照](../experiments/2026-09-19-parity-and-lifecycle.md)、后续自有日文运行记录和用户试听反馈。自有运行时仍未完成产品验收；表中的上游生成结果不能作为自有引擎的兼容声明。
