...
| V2ProPlus：Sakura | 本轮未在 MPS 运行 | 本轮未运行 | Windows 新样音人工听音与日文 ASR 尚未完成 | 已按真实 ProPlus 结构转换并接通原始日文到 WAV；数值和性能的通过项、失败项见 Windows 记录 | RTX 5060 8 GB 已执行官方与自有链路，限该组权重及记录中的输入，不代表家族全面兼容 |
