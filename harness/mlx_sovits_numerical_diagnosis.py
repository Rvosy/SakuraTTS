...
from sakuratts.mlx_sovits_decoder import sha256
...
def main():
    ...
    files = ["harness/mlx_sovits_numerical_diagnosis.py", "harness/mlx_sovits_decoder_replay.py",
             *[f"src/sakuratts/{name}.py" for name in ("mlx_sovits", "mlx_sovits_encoder", "mlx_sovits_flow", "mlx_sovits_decoder")]]
    if (project / "src/sakuratts/weight_storage.py").exists():
