...
from sakuratts.sampling import exclude_initial_eos, logits_to_probs
...
def main():
    ...
    files = ("harness/gpt_probability_sensitivity.py", "src/sakuratts/sampling.py", "harness/sovits_fixed_conditions.py")
    for name in files:
    ...
    if sha256(project / "src/sakuratts/sampling.py") != sha256(args.native_run / "source/src/sakuratts/sampling.py"):
