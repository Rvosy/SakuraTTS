...
sys.path[:0] = [str(PROJECT / "src"), str(PROJECT / "scripts"), str(PROJECT / "harness")]
...
def main():
    ...
    capture_parser.add_argument("--case", type=Path, default=PROJECT / "harness/cases/japanese_long_validation.json")
    ...
    check.add_argument("--case", type=Path, default=PROJECT / "harness/cases/japanese_long_validation.json")
