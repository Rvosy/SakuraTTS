...
from sakuratts.mlx_sovits_decoder import MLXSoVITSDecoder, leaky_relu, sha256
...
def main():
    ...
    files = ("harness/decoder_workspace.py", "harness/mlx_sovits_encoder_replay.py",
             "src/sakuratts/mlx_sovits_decoder.py", "src/sakuratts/weight_storage.py")
    for name in files:
