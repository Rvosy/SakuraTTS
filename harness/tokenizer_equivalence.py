...
def native_g2pw(source, tokenizer, *, use_mask=True):
    from sakuratts.g2pw_inputs import G2PWInputs, tokenize_and_map
...
def validate(args):
    ...
    report = dict(status="passed" if passed else "mismatch", **info,
                  ...
                  candidate_g2pw_implementation="sakuratts.g2pw_inputs.G2PWInputs",
    ...
    shutil.copy2(PROJECT / "src/sakuratts/g2pw_inputs.py", output / "g2pw_inputs.py")
