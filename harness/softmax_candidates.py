...
separate full-acoustic candidate harness.
"""
...
def install_softmax_candidate(candidate):
    ...
    import sakuratts.mlx_sovits_encoder as encoder
...
def main():
    ...
    files = ("harness/softmax_candidates.py", "harness/mrte_numerical_diagnosis.py", "harness/sovits_fixed_conditions.py")
    for name in files:
