...
from export_sovits_onnx import PreparedDecoder, STAGES, compare, load_official, sha256
...
def main():
    ...
    if args.runtime_python:
        ...
        report = {"scope": "Offline alternate-Python diagnostic; not standalone product delivery",
                  ...
                  "existing_tolerance_source": "docs/experiments/2026-09-19-sovits-fixed-conditions.md: atol=1e-4, rtol=1e-5",
