...
from sakuratts.mlx_sovits_encoder import sha256
...
def main():
    ...
    files = ["harness/encoder_norm_candidate.py", "harness/encoder_layer_diagnosis.py", "harness/mrte_numerical_diagnosis.py",
