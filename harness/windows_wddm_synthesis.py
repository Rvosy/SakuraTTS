...
def main():
    ...
    try:
        ...
        for name in ("harness/windows_wddm_synthesis.py", "harness/windows_wddm_memory.py", "src/sakuratts/nvidia.py",
                     "src/sakuratts/cuda_gpt.py", "src/sakuratts/ort_sovits.py", "src/sakuratts/ort_process.py"):
