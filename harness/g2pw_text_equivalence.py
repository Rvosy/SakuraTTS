...
def prepare(args):
    ...
    shutil.copy2(PROJECT / "src/sakuratts/g2pw_text.py", source / "g2pw_text.py")
    shutil.copy2(__file__, source / "harness.py")
    shutil.copy2(PROJECT / "harness/g2pw_dedup_diagnostic.py", source / "g2pw_dedup_diagnostic.py")
