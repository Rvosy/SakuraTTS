...
def prepare(args):
    ...
    shutil.copy2(Path(__file__), run / "harness.py")
    shutil.copy2(PROJECT / "src/sakuratts/g2pw_session.py", run / "g2pw_session.py")
...
def execute(args):
    ...
    if sha256(PROJECT / "src/sakuratts/g2pw_session.py") != prepared["files"]["g2pw_session.py"]:
