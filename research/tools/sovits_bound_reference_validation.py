...
def run(args):
    ...
    files = sorted(set(prior["source_sha256"]) | {"research/tools/sovits_bound_reference_validation.py"})
    ...
    for variant in VARIANTS:
        command = [sys.executable, str(output / "source/research/tools/sovits_bound_reference_validation.py"),
