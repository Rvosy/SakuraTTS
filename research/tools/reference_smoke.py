...
def main() -> None:
    ...
    parser.add_argument("--case-ids", nargs="+", help="IDs from benchmarks/cases/speech_regressions.json; overrides --languages")
    ...
    cases_path = Path(__file__).resolve().parents[2] / "benchmarks/cases/speech_regressions.json"
    ...
    evidence_code = output / "source" / "research/tools"
