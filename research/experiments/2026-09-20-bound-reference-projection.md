...
`research/tools/sovits_bound_projection.py` 只在实验类中实现绑定。一次装载只打开并校验一次完整 SoVITS 包，依次完成：
...
/Users/beyondpower/Documents/Projects/SakuraTTS-References/.venv-japanese-macos/bin/python \
  /Users/beyondpower/Documents/Projects/SakuraTTS/research/tools/sovits_bound_projection.py run \
