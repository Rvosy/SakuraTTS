# 2026-09-20 Windows 接续验收记录

以下为 CUDA 后端接通前的交接方案与便携验收格式。其进度和路径保留为历史记录；现行 Windows 用法见[部署指南](../../docs/setup-windows-nvidia.md)，后续结果见[Windows 后端实测](../experiments/2026-09-20-windows-nvidia-backend.md)。
